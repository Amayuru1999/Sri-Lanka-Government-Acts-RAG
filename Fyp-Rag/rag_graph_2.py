...
if __name__ == "__main__":
    ...
    try:
        ...
        print("=== Welcome to Autonomous Legal RAG System ===")
        print(f"Loaded {len(collections_dict)} legal act collections: {available_collections}")
        print("This system will intelligently analyze your questions and guide you through the process.")
